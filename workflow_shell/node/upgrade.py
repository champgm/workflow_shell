...
command_help = (
    "Takes two required arguments, the package to update and the target version. "
    + "Updates all NPM projects with that package to the specified version"
)
short_help = "NPM - update dependencies in all sub-projects"
...
def main(*args, **kwargs):
    ...
    for package_json_path in package_json_paths:
        ...
        if package in package_json:
            ...
            new_package_json = re.sub(replace_pattern, new_string, package_json)
